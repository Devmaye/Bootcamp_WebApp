			        ...
			        <ul class="nav-menu">
			          ...
			          <li class="menu-has-children"><a href="">Blog</a>
			            <ul>
			              ...
			              <li><a href="blog-single.html">Blog Single</a></lis>
			            </ul>
			          </li>	
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="gallery.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="gallery.php"> Gallery</a></p>
						</div>	
					</div>
				</div>
			</section>
